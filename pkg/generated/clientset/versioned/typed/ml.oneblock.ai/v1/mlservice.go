...
// MLServicesGetter has a method to return a MLServiceInterface.
...
// mLServices implements MLServiceInterface
type mLServices struct {
	client rest.Interface
	ns     string
}

// newMLServices returns a MLServices
func newMLServices(c *MlV1Client, namespace string) *mLServices {
	return &mLServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *mLServices) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.MLService, err error) {
	result = &v1.MLService{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mlservices").
...
func (c *mLServices) List(ctx context.Context, opts metav1.ListOptions) (result *v1.MLServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.MLServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mlservices").
...
func (c *mLServices) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mLServices) Create(ctx context.Context, mLService *v1.MLService, opts metav1.CreateOptions) (result *v1.MLService, err error) {
	result = &v1.MLService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mlservices").
...
func (c *mLServices) Update(ctx context.Context, mLService *v1.MLService, opts metav1.UpdateOptions) (result *v1.MLService, err error) {
	result = &v1.MLService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mlservices").
...
func (c *mLServices) UpdateStatus(ctx context.Context, mLService *v1.MLService, opts metav1.UpdateOptions) (result *v1.MLService, err error) {
	result = &v1.MLService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mlservices").
...
func (c *mLServices) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *mLServices) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *mLServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.MLService, err error) {
	result = &v1.MLService{}
