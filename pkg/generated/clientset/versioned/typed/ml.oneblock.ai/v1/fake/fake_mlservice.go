...
var mlservicesResource = v1.SchemeGroupVersion.WithResource("mlservices")

var mlservicesKind = v1.SchemeGroupVersion.WithKind("MLService")
...
func (c *FakeMLServices) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.MLService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(mlservicesResource, c.ns, name), &v1.MLService{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1.MLService), err
}
...
func (c *FakeMLServices) List(ctx context.Context, opts metav1.ListOptions) (result *v1.MLServiceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(mlservicesResource, mlservicesKind, c.ns, opts), &v1.MLServiceList{})
	...
	list := &v1.MLServiceList{ListMeta: obj.(*v1.MLServiceList).ListMeta}
	for _, item := range obj.(*v1.MLServiceList).Items {
...
func (c *FakeMLServices) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(mlservicesResource, c.ns, opts))
...
func (c *FakeMLServices) Create(ctx context.Context, mLService *v1.MLService, opts metav1.CreateOptions) (result *v1.MLService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(mlservicesResource, c.ns, mLService), &v1.MLService{})
...
func (c *FakeMLServices) Update(ctx context.Context, mLService *v1.MLService, opts metav1.UpdateOptions) (result *v1.MLService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(mlservicesResource, c.ns, mLService), &v1.MLService{})
...
func (c *FakeMLServices) UpdateStatus(ctx context.Context, mLService *v1.MLService, opts metav1.UpdateOptions) (*v1.MLService, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(mlservicesResource, "status", c.ns, mLService), &v1.MLService{})
...
func (c *FakeMLServices) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(mlservicesResource, c.ns, name, opts), &v1.MLService{})
...
func (c *FakeMLServices) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(mlservicesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1.MLServiceList{})
	return err
}
...
func (c *FakeMLServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.MLService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(mlservicesResource, c.ns, name, pt, data, subresources...), &v1.MLService{})
