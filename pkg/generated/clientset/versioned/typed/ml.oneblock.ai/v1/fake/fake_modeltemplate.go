...
var modeltemplatesResource = v1.SchemeGroupVersion.WithResource("modeltemplates")

var modeltemplatesKind = v1.SchemeGroupVersion.WithKind("ModelTemplate")
...
func (c *FakeModelTemplates) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ModelTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(modeltemplatesResource, c.ns, name), &v1.ModelTemplate{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1.ModelTemplate), err
}
...
func (c *FakeModelTemplates) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ModelTemplateList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(modeltemplatesResource, modeltemplatesKind, c.ns, opts), &v1.ModelTemplateList{})
	...
	list := &v1.ModelTemplateList{ListMeta: obj.(*v1.ModelTemplateList).ListMeta}
	for _, item := range obj.(*v1.ModelTemplateList).Items {
...
func (c *FakeModelTemplates) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(modeltemplatesResource, c.ns, opts))
...
func (c *FakeModelTemplates) Create(ctx context.Context, modelTemplate *v1.ModelTemplate, opts metav1.CreateOptions) (result *v1.ModelTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(modeltemplatesResource, c.ns, modelTemplate), &v1.ModelTemplate{})
...
func (c *FakeModelTemplates) Update(ctx context.Context, modelTemplate *v1.ModelTemplate, opts metav1.UpdateOptions) (result *v1.ModelTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(modeltemplatesResource, c.ns, modelTemplate), &v1.ModelTemplate{})
...
func (c *FakeModelTemplates) UpdateStatus(ctx context.Context, modelTemplate *v1.ModelTemplate, opts metav1.UpdateOptions) (*v1.ModelTemplate, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(modeltemplatesResource, "status", c.ns, modelTemplate), &v1.ModelTemplate{})
...
func (c *FakeModelTemplates) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(modeltemplatesResource, c.ns, name, opts), &v1.ModelTemplate{})
...
func (c *FakeModelTemplates) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(modeltemplatesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1.ModelTemplateList{})
	return err
}
...
func (c *FakeModelTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ModelTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(modeltemplatesResource, c.ns, name, pt, data, subresources...), &v1.ModelTemplate{})
